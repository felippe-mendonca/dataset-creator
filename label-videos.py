...
parser.add_argument('--skip-labeled', '-s', action='store_true', help='If set, skips videos already labeled.')
        ...
        while True:
            ...
            if key == ord(keymap['begin_label']):
                if labels[it_frames] == 0 and not waiting_end:
                    ...
                    waiting_end = False
                    update_image = True
                elif (labels[it_frames] == -1 or labels[it_frames] == 3) and not waiting_end:
